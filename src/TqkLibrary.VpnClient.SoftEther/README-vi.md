...
- **Còn lại (sau V.4 payload codec)**: IPv6 trong tunnel; watermark blob thật + validate live (Q.1). Lộ trình V.4 đầy đủ ở [`.docs/11`](../../.docs/11-todo-roadmap.md) §V.4; design-intent SoftEther ở [`.docs/07`](../../.docs/07-softether.md).
