...
| `SoftEtherSessionParams` | record session: `MaxConnection`/`UseEncrypt`(mặc định `false`)/`UseCompress`(mặc định `false`)/`HalfConnection`/`UniqueId` | [Models/SoftEtherSessionParams.cs:11](Models/SoftEtherSessionParams.cs#L11) |
