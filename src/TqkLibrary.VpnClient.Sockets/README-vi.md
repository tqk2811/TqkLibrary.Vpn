...
| RFC 1071 — Internet checksum (1's-complement) | `InternetChecksum` (qua `Ipv4.Build` / `TcpSegment.Build` / `UdpDatagram.Build`) | [InternetChecksum.cs:3](../TqkLibrary.VpnClient.IpStack/InternetChecksum.cs#L3) | **cited-in-code** (`... Internet checksum (RFC 1071) ...`); hàm `Compute` ở [InternetChecksum.cs:7](../TqkLibrary.VpnClient.IpStack/InternetChecksum.cs#L7), được `Ipv4.Build` gọi tại [Ipv4.cs:36](../TqkLibrary.VpnClient.IpStack/Ipv4.cs#L36) |
