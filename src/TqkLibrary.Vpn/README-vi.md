...
| RFC 2661 (L2TPv2) | `L2tpIpsecDriver` | [L2tpIpsecDriver.cs:7](../TqkLibrary.Vpn.Drivers.L2tpIpsec/L2tpIpsecDriver.cs#L7) | (suy luận) — comment driver "L2TP"; hiện thực ở L2tp |
| RFC 1661/1332 (PPP/IPCP) | cả 2 driver (`UsesPpp`, `AddressAssignment.Ipcp`) | [SstpDriver.cs:22-31](../TqkLibrary.Vpn.Drivers.Sstp/SstpDriver.cs#L22-L31), [L2tpIpsecDriver.cs:27-36](../TqkLibrary.Vpn.Drivers.L2tpIpsec/L2tpIpsecDriver.cs#L27-L36) | (suy luận) — IP cấp qua IPCP; hiện thực ở Ppp |
...
- **PSK bắt buộc:** `L2tpIpsecDriver` **không** nhét PSK mặc định — `VpnCredentials.PreSharedKey` null/rỗng ⇒ ném `ArgumentException` (default credential đặc thù VPN Gate không thuộc lib chung) — [L2tpIpsecDriver.cs:41-45](../TqkLibrary.Vpn.Drivers.L2tpIpsec/L2tpIpsecDriver.cs#L41-L45). Group PSK `"vpn"` của VPN Gate nằm ở tầng demo ([VpnTarget ctor `?psk=` default :16](../../demo/Vpn2ProxyDemo/CommandModules/Models/VpnTarget.cs#L16)).
