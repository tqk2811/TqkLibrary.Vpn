...
Cách dùng thật trong driver: [L2tpIpsecConnection.cs:328-337](../TqkLibrary.VpnClient.Drivers.L2tpIpsec/L2tpIpsecConnection.cs#L328-L337) (handshake Phase 1/2) — vòng nhận demux IKE/ESP ở [L2tpIpsecConnection.cs:532-560](../TqkLibrary.VpnClient.Drivers.L2tpIpsec/L2tpIpsecConnection.cs#L532-L560).
...
- **Đang chạy thực tế:** `Ike/V1` + `Esp/` + `Nat/` — driver `L2tpIpsec` dựng `IkeV1Client` + `NatTraversalChannel` trong `BringUpPhase1Async` ([L2tpIpsecConnection.cs:328](../TqkLibrary.VpnClient.Drivers.L2tpIpsec/L2tpIpsecConnection.cs#L328)) và demux IKE/ESP ở `ReceiveLoopAsync` ([L2tpIpsecConnection.cs:532](../TqkLibrary.VpnClient.Drivers.L2tpIpsec/L2tpIpsecConnection.cs#L532)), dùng `EspSession`/`EspCipherSuite` cho data plane. Đã verify live trên VPN Gate (PSK + AES-256 + HMAC-SHA1, MODP group 2/14).
