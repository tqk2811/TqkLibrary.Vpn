namespace TqkLibrary.VpnClient.Drivers.L2tpIpsec
{
    ...
    public sealed class L2tpIpsecTimeoutOptions
    {
        ...
        /// <summary>How many times an IKE message is sent before giving up with a <see cref="TqkLibrary.VpnClient.Abstractions.Drivers.VpnNetworkTimeoutException"/>.</summary>
        ...
        /// <summary>Builds the reliable control-channel policy passed to <see cref="TqkLibrary.VpnClient.L2tp.L2tpClient"/>.</summary>
        public TqkLibrary.VpnClient.L2tp.L2tpRetransmitOptions BuildL2tpRetransmitOptions()
            => new()
            {
