...
- **Phụ thuộc (ProjectReference):**
  ...
  - [TqkLibrary.VpnClient.Drivers.Core](../TqkLibrary.VpnClient.Drivers.Core) — base supervisor [`ReconnectingVpnConnection<TState>`](../TqkLibrary.VpnClient.Drivers.Core/ReconnectingVpnConnection.cs#L25) + model reconnect chung [`VpnReconnectOptions`](../TqkLibrary.VpnClient.Drivers.Core/Models/VpnReconnectOptions.cs#L14) (gom supervisor/backoff-jitter/StateChanged/link-loss/teardown — F.6).
...
| `L2tpIpsecReconnectOptions` | Chính sách auto-reconnect `: VpnReconnectOptions` (Drivers.Core — F.6): backoff/jitter/max attempts kế thừa từ base, không thêm knob; named type giữ cho API public của driver | [L2tpIpsecReconnectOptions.cs:11](L2tpIpsecReconnectOptions.cs#L11) |
