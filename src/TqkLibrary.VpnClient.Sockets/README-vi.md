...
| RFC 1071 — Internet checksum (1's-complement) | `InternetChecksum` (qua `Ipv4.Build` / `TcpSegment.Build` / `UdpDatagram.Build`) | [../TqkLibrary.VpnClient.Abstractions/Net/InternetChecksum.cs:6](../TqkLibrary.VpnClient.Abstractions/Net/InternetChecksum.cs#L6) | **cited-in-code** (`... Internet checksum (RFC 1071) ...`); codec **nay ở Abstractions.Net** (dời khỏi IpStack, dùng chung IpStack/Ethernet/IpEncap); hàm `Compute` được `Ipv4.Build` gọi tại [Ipv4.cs:36](../TqkLibrary.VpnClient.IpStack/Ipv4.cs#L36) |
