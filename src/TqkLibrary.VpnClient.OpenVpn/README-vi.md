...
| NCP + compression framing | `OpenVpnDataCipher`/`OpenVpnPeerInfo`/`OpenVpnCompression` | IV_CIPHERS=AES-256-GCM:AES-128-GCM:CHACHA20-POLY1305 peer-info, server chốt `cipher` ở PUSH_REPLY; comp-lzo/stub-v2 framing (no-compress) |
