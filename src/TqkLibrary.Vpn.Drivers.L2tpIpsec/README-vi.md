...
| RFC 3947 / 3948 (IPsec NAT-T, UDP 500↔4500) | `NatTraversalChannel` (từ `Ipsec/Nat`), `natt.SwitchToNatTPort()` | [L2tpIpsecConnection.cs:144](L2tpIpsecConnection.cs#L144) | (suy luận) — hiện thực ở [`Ipsec/Nat`](../TqkLibrary.Vpn.Ipsec/Nat) |
