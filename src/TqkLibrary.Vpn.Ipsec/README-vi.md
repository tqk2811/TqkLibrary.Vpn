...
- **Đang chạy thực tế:** `Ike/V1` + `Esp/` + `Nat/` — driver `L2tpIpsec` dùng `IkeV1Client` ([L2tpIpsecConnection.cs:195](../TqkLibrary.Vpn.Drivers.L2tpIpsec/L2tpIpsecConnection.cs#L195)), `NatTraversalChannel` ([L2tpIpsecConnection.cs:248](../TqkLibrary.Vpn.Drivers.L2tpIpsec/L2tpIpsecConnection.cs#L248)) và `EspSession`/`EspCipherSuite` cho data plane. Đã verify live trên VPN Gate (PSK + AES-256 + HMAC-SHA1, MODP group 2/14).
